...
-- freedesktop application libaray
...
tags = {}
tagconfig = {
    names = { "web", "term", "workspace", "email", "office", "manager", "virtual", "media", 9 },
    layouts = { layouts[0], layouts[3], layouts[0], layouts[0], 
        layouts[0], layouts[0], layouts[0], layouts[0],layouts[0] }
}
for s = 1, screen.count() do
    -- Each screen has its own tag table.
    tags[s] = awful.tag(tagconfig.names, s, tagconfig.layouts[s-1])
end
-- }}}
